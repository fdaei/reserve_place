...
class Restaurants extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.restaurants', [
            ...
            'cities' => City::query()
                ...
                ->get(),
            'stats' => [
                'total' => FoodStore::count(),
                'active' => FoodStore::where('status', 1)->count(),
                'pending' => FoodStore::where('status', 0)->count(),
            ],
        ])
            ->extends('app')
            ->section('content');
    ...
    public function approve($id)
    {
        ...
        session()->flash('admin_success', 'رستوران با موفقیت تایید شد.');
        $this->resetPage();
    }
    ...
    public function remove($id)
    {
        ...
        session()->flash('admin_success', 'رستوران با موفقیت حذف شد.');
        $this->resetPage();
    }
}
