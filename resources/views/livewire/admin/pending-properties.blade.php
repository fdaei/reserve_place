<div class="section listing-panel">
                        ...
                        <td data-label="عملیات">
                            <div class="pending-actions">
                                ...
                                <button
                                    ...
                                    wire:confirm="این اقامتگاه رد و حذف می‌شود. ادامه می‌دهید؟"
                                >
                                    رد
                                </button>
                            </div>
    ...
    @else
        <div class="admin-empty-state">
            <h4>درخواستی برای بررسی وجود ندارد</h4>
            <p>همه اقامتگاه‌های ثبت‌شده تعیین تکلیف شده‌اند.</p>
        </div>
    @endif
</div>
