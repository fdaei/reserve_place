<div class="section listing-panel">
    ...
    <div class="listing-toolbar">
        ...
        <div class="listing-toolbar-actions">
            ...
            <a href="{{ url('add-tour') }}" class="toolbar-btn toolbar-btn--success">
                <span>+</span>
                جدید
            </a>
        </div>
            ...
            <table class="table responsive-table listing-table">
                ...
                @foreach($list as $item)
                    ...
                    <tr>
                        ...
                        <td data-label="تاریخ برگزاری">
                            {{ convertEnglishToPersianNumbers(str_replace('-', '/', $item->expire_date ?: '-')) }}
                        </td>
                        <td data-label="وضعیت">
                        ...
                        <td data-label="عملیات">
                            <div class="listing-actions">
                                ...
                                <button
                                    ...
                                    wire:confirm="از حذف تور {{ $item->title }} اطمینان دارید؟"
                                    aria-label="حذف"
                                >
